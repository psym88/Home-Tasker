...
export class HomeTaskerCard extends HomeTaskerBase {
  ...
  render(){
    ...
    root.insertAdjacentHTML("beforeend",'<style>.task-row{border-color:var(--divider-color)}.add-task{justify-content:center;text-align:center}</style>'+ROW_ACTION_MENU_STYLES+this.themeStyles()+this.pillIconCss()+this.iconHoverStyles());
