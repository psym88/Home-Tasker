...
export const withTaskList = Base => class extends Base {
  ...
  render(){
    ...
    app.insertAdjacentHTML("beforeend",ROW_ACTION_MENU_STYLES+this.themeStyles()+this.typographyStyles()+this.buttonThemeStyles()+this.iconHoverStyles()+this.groupListStyles()+this.pillStyles()+`<style>.placeholder-add{justify-content:center;text-align:center}</style>`);
