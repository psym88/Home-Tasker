...
All Home Tasker viewers, forms, and confirmations are registered standalone dialog elements opened with composed, bubbling `show-dialog` events. They use Home Assistant adaptive-dialog primitives but have no Browser Mod dependency.
