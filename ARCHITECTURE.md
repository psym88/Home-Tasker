...
All Home Tasker viewers, forms, and confirmations are registered standalone dialog elements opened with composed, bubbling `show-dialog` events. They use Home Assistant adaptive-dialog primitives but have no Browser Mod dependency. Viewer completion and form save actions occupy the adaptive dialog's native footer slot, independent of the scrolling content area.
